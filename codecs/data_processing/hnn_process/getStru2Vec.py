...
def main():
    sqlang_type = 'mysql'  # 指定SQL语言类型
    split_num = 500  # 一次性处理的问题数
    staqc_python_path = '../hnn_process/ulabel_data/python_staqc_qid2index_blocks_unlabeled.txt'  # Python语言源数据文件的路径
    staqc_python_save = '../hnn_process/ulabel_data/staqc/python_staqc_unlabled_data.txt'  # 处理后的Python语言数据保存路径
    staqc_sql_path = '../hnn_process/ulabel_data/sql_staqc_qid2index_blocks_unlabeled.txt'  # SQL语言源数据文件的路径
    staqc_sql_save = '../hnn_process/ulabel_data/staqc/sql_staqc_unlabled_data.txt'  # 处理后的SQL语言数据保存路径

    process_data(sqlang_type, split_num, staqc_sql_path, staqc_sql_save)  # 处理SQL语言数据
    process_data(python_type, split_num, staqc_python_path, staqc_python_save)  # 处理Python语言数据
